<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PasswordReset.aspx.cs" Inherits="Pantheon.PasswordReset" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Reset Password | Delonix Regia
</asp:Content>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div role="form">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="Text2" placeholder="New Password" runat="server">
                                        </div>
                                    </div>
