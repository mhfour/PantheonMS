<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConfirmCheckout.aspx.cs" Inherits="Pantheon.ConfirmCheckout" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Check-out Confirmation | Delonix Regia
</asp:Content>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col col-md-12">
                            <h2>Confirm checking out of this guest?</h2>
                        </div>
                        <div class="col col-md-12">
