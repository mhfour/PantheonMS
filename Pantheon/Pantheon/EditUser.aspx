<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="Pantheon.EditUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Edit User Account | Delonix Regia
</asp:Content>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls col-md-12">
                                                <label class="radio" for="updatedStatus-0">
                                                    <input type="radio" name="updatedStatus" id="updatedStatus-0" value="1">
                                                    1
                                                </label>
                                                ...
                                                <label class="radio" for="updatedStatus-3">
                                                    <input type="radio" name="updatedStatus" id="updatedStatus-3" value="4" checked="checked">
                                                    4
                                                </label>
                                            </div>
                                        </div>
